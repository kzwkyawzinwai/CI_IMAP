 ...
 * @category    Libraries
 * @author      Kyaw Zin Wai
 * @link        https://github.com/kzwkyawzinwai/CI_IMAP/blob/master/Imap.php
 * 
 * 26-Dec-2016 - Update for php-imap fix
 * 
 * 
 */
class CI_Imap extends CI_Email {
    
    var $imap_host      = "";       // IMAP Server.  Example: imap.gmail.com
    var $imap_user      = "";       // IMAP Username.
